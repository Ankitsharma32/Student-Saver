...
?>
                ...
                <body class="fix-header fix-sidebar">
                    ...
                    <div id="main-wrapper">
                                        ...
                                        <li class="nav-item dropdown">
                                            <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="images/bookingSystem/yash.jpg" width="24px" alt="user" class="profile-pic" /></a>
                    ...
                    <footer class="footer"> Group 7 © 2023 - Rental Book </footer>
